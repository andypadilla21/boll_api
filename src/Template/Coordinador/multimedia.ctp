...
<div class="">
  ...
  <div class="card-content">
    ...
    <?php foreach($bol as $p): ?>
      <?= $this->Form->create(null, ['url' => ['controller' => 'Coordinador', 'action' => 'borrarvideo'], 'id' => 'formprueba']);?>
      <div class="row col s8">
        ...
        <div class="col s4 m4 l4">
          ...
          <input type="hidden" name="cod" value="<?php echo $p['Codigo'];?>">
            <button title="Borrar" class="btn waves-effect waves-light green darken-4" type="submit" name="del" onchange="enviar()"><i class="mdi-action-delete"></i></button>
        </div>
      </div>
    <?= $this->Form->end() ?>
    <?php endforeach;?> 
    ...
    <div id="mult">
    <br>
      <?= $this->Form->create(null, ['url' => ['controller' => 'Coordinador', 'action' => 'multimedia']]);?>
      <div class="row">
